            ...
            <div class="row">
                <div class="col-8 mx-auto text-center">
                    ...
                    <ul class="list-inline breadcrumbs text-capitalize" style="font-weight:500">
                        ...
                        <li class="list-inline-item">/ &nbsp; <a wire:navigate href="{{route('service')}}">Our Team</a>
                        </li>
                    </ul>
                </div>
            </div>
                        ...
                        <div class="card bg-transparent border-0 text-center">
                            <div class="card-img">
                                ...
                                <ul class="card-social list-inline">
                                    ...
                                    @endif
                                        @if($member->in_url !='')
                                    <li class="list-inline-item"><a class="twitter" href="{{$member->in_url}}"><i class="fab fa-linkedin"></i></a>
                                    </li>
                                        @endif
                                        @if($member->in_url !='')
                                        <li class="list-inline-item"><a class="instagram" href="{{$member->ins_url}}"><i class="fab fa-instagram"></i></a>
                                    </li>
                                        @endif
                                </ul>
                            </div>
